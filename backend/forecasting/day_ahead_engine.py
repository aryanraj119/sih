"""
URJADRISHTI — Day-Ahead Forecasting Engine (1 – 7 Days ⭐ PRIMARY HORIZON)
Focus: Power procurement, generator scheduling, unit commitment, day-ahead peak.
Powered directly by OpenSTEF adapter.
"""
...
class DayAheadEngine(ForecastEngine):
    ...
    def forecast(self, params: Dict[str, Any]) -> List[Dict[str, Any]]:
        return self.openstef.predict_day_ahead(params)
    ...
    def forecast_ramp(self, data: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        for i in range(1, len(data)):
            ...
            ramp_mw_min = round(diff_mw / 60.0, 1) # hourly intervals
        ...
        return {
            ...
            "status": "ELEVATED RAMP" if max_ramp > 30.0 else "STABLE"
        }
